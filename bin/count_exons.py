...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--output', default='exon_counts_combined.txt',
                        help='Output file name (default: exon_counts_combined.txt)')
    ...
    if args.label:
        ...
        labels = [os.path.splitext(os.path.basename(gff_file))[0].replace('.reformatted', '') for gff_file in args.gff_files]
